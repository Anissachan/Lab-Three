...
Start
 ...
 ; Initialization goes here
	   ...
	   LDR R0, [R1]
	   AND R0, #0xF2	;preserve PE4 and PE5 bits ;PE1 is input
	   ORR R0, #0x08	;configuring PE3 as output and PE2 as input
	   STR R0, [R1]
	  
	   LDR R1, =GPIO_PORTE_DEN_R
	   LDRB R0, [R1]
	   ORR R0, #0x0E	;enabling PE3 and PE2 ;and PE1
	   STRB R0, [R1]
...
checkBreathing
	   ...
	   LDR R0, [R1]
	   AND R6, R0, #0x02 ;isolating porte1
	   LSR R6, #1
	   CMP R6, #1		;if (R0==0) ((if switch is pressed now)
	   BNE skipBreathe
